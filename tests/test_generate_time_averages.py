...
def test_compare_fre_python_tools_to_fre_nctools():
    ...
    str_fre_nctools_inf='tests/time_avg_test_files/fre_nctools_timavg_CLI_test_r8_b_atmos_LWP_1979_5y.nc'
    ...
    fre_pytools_timavg=fre_pytools_inf['LWP'][:].copy()    
    fre_nctools_timavg=fre_nctools_inf['LWP'][:].copy()

...
function fre_nctools_timavg_ex(){
	...
	#outfile=$TESTFILE_DIR/fre_nctools_timavg_CLI_test_r4_mb_${PP_COMP}_${VAR}_1979_5y.nc
	#if [ -f $outfile ] ; then rm -f $outfile ; fi
	#timavg.csh -r4 -mb -o $outfile $TESTFILE
	#ls $outfile
	#ncdiff $outfile tests/time_avg_test_files/frepytools_timavg_atmos.197901-198312.LWP.nc ./frepytools_v_frenc_timavg_r4mb.nc
	#unset outfile
	...
	#outfile=$TESTFILE_DIR/fre_nctools_timavg_CLI_test_r4_b_${PP_COMP}_${VAR}_1979_5y.nc
	#if [ -f $outfile ] ; then rm -f $outfile ; fi
	#timavg.csh -r4 -b -o $outfile $TESTFILE
	#ls $outfile
	#ncdiff $outfile tests/time_avg_test_files/frepytools_timavg_atmos.197901-198312.LWP.nc ./frepytools_v_frenc_timavg_r4b.nc
	#unset outfile
